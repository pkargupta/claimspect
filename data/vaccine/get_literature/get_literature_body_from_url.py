...
SAVE_PATH = "data/vaccine/get_literature/literature_body"
MAX_PAPER_NUM = 100

random.seed(42)

def load_meta_info(meta_info_path: str="data/vaccine/get_literature/claim2paper_meta_info.json"):
...
class Claim2idConverter:
    ...
    def __init__(self, 
                 claim_json_path: str="data/vaccine/claims.json"):
