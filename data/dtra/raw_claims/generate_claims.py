...
def main():
    ...
    organized_responses = chat([ORGANIZE_LIST_PROMPT.format(claim_list=pos+neg) for pos, neg in zip(raw_responses_pos, raw_responses_neg)], model_name='gpt-4o-mini',seed=42)
