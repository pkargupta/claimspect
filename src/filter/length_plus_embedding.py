...
if __name__ == "__main__":
    ...
    """ no length, top 100 """
    # filter_obj = LengthPlusEmbeddingFilter(char_length_threshold=1)
    """ length, top 100 """
    # filter_obj = LengthPlusEmbeddingFilter()
    """ no length, top 50 """
    # filter_obj = LengthPlusEmbeddingFilter(char_length_threshold=1, embedding_top_k=50)
    """ length, top 50 """
    filter_obj = LengthPlusEmbeddingFilter(embedding_top_k=50)
    ...
    """ no length, top 100 """
    # output_path = "filter/example_data/filter_output_embedding_top100.json"
    """ length, top 100 """
    # output_path = "filter/example_data/filter_output_length_plus_embedding_top100.json"
    """ no length, top 50 """
    # output_path = "filter/example_data/filter_output_embedding_top50.json"
    """ length, top 50 """
    output_path = "filter/example_data/filter_output_length_plus_embedding_top50.json"
